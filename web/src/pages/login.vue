<template>
    <div class="flex min-h-full">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96 p-3 lg:backdrop-blur-md lg:rounded-3xl lg:shadow lg:bg-neutral-100 lg:bg-opacity-40">
                <div class="">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        Or {{ ' ' }} <NuxtLink class="font-medium text-blue-600 hover:text-blue-500" to="/signup">sign up for
                        your SSI wallet</NuxtLink>! </p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-6">
                        <form class="space-y-6" @submit.prevent="login">
                            ...
                            <div>
                                <button :class="[success ? 'bg-green-500 hover:bg-green-600 animate-bounce' : 'bg-blue-600  hover:bg-blue-500']"
                                        ...
                                        type="submit">
                                    Sign in
                                    <svg v-if="isLogin" class="animate-spin ml-1.5 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center justify-between pb-2">
                                <div class="flex items-center">
                                    <input id="remember-me" class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600" name="remember-me" type="checkbox"/> <label
                                    class="ml-2 block text-sm text-gray-900" for="remember-me">
                                        <span class="flex flex-row items-center">
        ...
        <div class="overflow-hidden max-h-screen absolute left-0 w-full h-full -z-10 hidden lg:block">
            <img ref="container" :class="[isLogin ? 'zoom-in' : 'zoom-out']" alt="" class="absolute inset-0 h-full w-full object-cover hidden lg:block -z-10"
        ...
        <div :class="[isLogin ? 'animate-spin' : '']" :style="cardStyle" class="absolute bottom-3.5 right-3.5 w-10 lg:w-16 h-10 lg:h-16 overflow-hidden">
                        ...
                        <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                            ...
                            <DialogPanel
                                ...
                                <div class="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
                                    <button class="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                    <button
                                        ...
                                        type="button" @click="closeModal">Okay
                                    </button>
                                </div>
                            </DialogPanel>
                        </TransitionChild>

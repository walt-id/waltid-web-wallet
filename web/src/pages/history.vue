<template>
    <CenterMain>
        ...
        <div aria-label="Credential list" class="h-full overflow-y-auto shadow-xl" v-if="groupedHistoryElements.size > 0">
                        ...
                        <div class="min-w-0">
                            <div class="flex items-start gap-x-3">
                                ...
                                <div v-if="element.entry.operation === 'useOfferRequest'">
                                    ...
                                    <p class="text-xs overflow-x-scroll w-1/3 h-5"><code>{{ JSON.stringify(element.entry.data) }}</code></p>
                                </div>
                            ...
                            <div class="mt-1 flex items-center gap-x-2 text-xs leading-5 text-gray-500">
                                ...
                                <p class="truncate w-1/4">Commenced by <code>{{ element.entry.data.did }}</code></p>
                            </div>
                        </div>
                    </li>
                </ul>
...
watch(history, () => {
    ...
    if (history != null && history.value != null) {
        ...
        let i = 0
        groupedHistoryElements.value = groupBy(history.value.map(entry => {

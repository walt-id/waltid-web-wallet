        ...
        <ol class="divide-y divide-gray-100 list-decimal border rounded-2xl mt-2 px-3" role="list">
            <li v-for="method in methods" :key="method[0]" class="flex items-center justify-between gap-x-6 py-4">
                ...
                <div class="flex flex-none items-center gap-x-4">
                    <button @click=generateKey(method[1][0]) class="w-32 text-center rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">
                        Generate {{ method[1][0]}}
                    </button>
                </div>
            </li>

<template>
    <CenterMain>
        ...
        <div v-if="exportedKey" class="my-2">
            ...
            <p v-else>Unfortunately, this Verifiable Credential is too big to be viewable as QR code (credential size is {{ exportedKey.length }} characters, but the maximum a QR code can
                hold is 4296).</p>

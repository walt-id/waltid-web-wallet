...
<div>
    <div class="-mt-px flex divide-x divide-gray-200" @click="emitDetailRequest">
        <div class="flex w-0 flex-1">
            <p class="group relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900 hover:bg-blue-500 hover:text-white duration-150">

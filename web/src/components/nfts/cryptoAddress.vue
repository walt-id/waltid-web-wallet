<template>
  <span :on-mouseenter="toggleTooltip(true)" :on-mouseleave="toggleTooltip(false)" class="text-label text-natural ml-2 leading-none dark:text-natural-300">{{ computedText }}

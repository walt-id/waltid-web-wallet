  ...
  <div>
    ...
    <div class="flex min-h-full items-end p-4 sm:items-center sm:p-0">
        <form class="space-y-6" @submit.prevent="addWallet">
            ...
            <div>
                <button class="inline-flex w-full justify-center items-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                        type="submit">Add
...
import {PlusIcon, CubeTransparentIcon, Square3Stack3DIcon} from "@heroicons/vue/20/solid";
...
// const {data: ecosystems, pending} = await useLazyFetch(`/r/wallet/web3/ecosystems`)
// refreshNuxtData()
const ecosystems = [
  "ethereum",
  "tezos",
